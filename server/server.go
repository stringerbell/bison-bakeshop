...
func main() {
	...
	http.HandleFunc("/api/pre-sales", handlePreSales)
	http.HandleFunc("/api/config", handleConfig)
	http.HandleFunc("/api/checkout-session", handleCheckoutSession)
	http.HandleFunc("/api/create-checkout-session", handleCreateCheckoutSession)
	http.HandleFunc("/api/webhook", handleWebhook)
	http.HandleFunc("/api/incoming-email", handleIncomingEmail)
	http.HandleFunc("/api/account", handleCreateAccount)
	http.HandleFunc("/api/login", handleLogin)
	http.HandleFunc("/api/logout", handleLogout)
	http.HandleFunc("/api/session", handleCreateSession)
	http.HandleFunc("/api/me", handleSessionRead)
